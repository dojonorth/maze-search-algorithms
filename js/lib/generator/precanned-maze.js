...
module.exports = function(mazeProblem) {
  var precannedMaze;

  switch (mazeProblem) {
    case 'mazeProblemOne':
      precannedMaze = mazeProblemOne;
      break;
    case 'mazeProblemTwo':
      precannedMaze = mazeProblemTwo;
      break;
    case 'mazeProblemThree':
      precannedMaze = mazeProblemThree;
      break;
    case 'mazeProblemFour':
      precannedMaze = mazeProblemFour;
      break;
    case 'mazeProblemFive':
      precannedMaze = mazeProblemFive;
      break;
    default:
      precannedMaze = mazeProblemOne;
      break;
  ...
  x = precannedMaze.length;
  y = precannedMaze[0].length;

  maze = {
    representation: precannedMaze,
    getY: function() {
      return y;
    },
    getX: function() {
